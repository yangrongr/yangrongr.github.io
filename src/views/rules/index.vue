<template>
 ...
 -->
    ...
    <el-row>
      <el-button type="primary" size="medium" @click="addData" style="margin-bottom: 20px;">添加</el-button>
    </el-row>
    <el-table :data="tableData" style="width: 100%" border >
      ...
      <el-table-column prop="rules" label="菜单ID" width="200"></el-table-column>
    ...
    <el-dialog title="提示" :visible.sync="dialogVisible" width="30%" :before-close="handleClose" @close="AddEditClose">
