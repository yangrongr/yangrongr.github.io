<template>
	<div>
		<el-row>
			<el-input type="text" style="width: 200px;" placeholder="请输入面额" v-model="sechName"></el-input>
      ...
      <el-button type="primary" size="medium" style="margin-bottom: 20px;" icon="el-icon-search" @click="sechClick(sechName)">搜索</el-button>
		...
		<div class="block" style="margin-top: 20px;">
			...
			<el-pagination @size-change="handleSizeChange" background @current-change="handleCurrentChange"
				:current-page="currentPage" :page-sizes="[2, 5, 10, 15]" :page-size="currentPageSize"
