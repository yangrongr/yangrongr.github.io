<template>
  <div>
    <el-row>
      <el-button type="primary" size="medium" @click="addClick" style="margin-bottom: 20px;">添加优惠券</el-button>
    </el-row>
...
<!-- 页数 -->
    ...
    <el-dialog title="添加" :visible.sync="dialogFormVisible" @close="AddEditClose">
      <el-form :model="form" :rules="rules" ref="ruleForm" label-width="labelWidth">
        ...
        <el-form-item label="兑换所需积分" prop="point" placeholder="兑换所需积分只能是数字，必须大于等于0,0表示不能兑换" >
          <el-input v-model="form.point" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="兑换有效期" prop="valid_days" >
